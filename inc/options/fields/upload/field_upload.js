jQuery(document).ready(function(){
	...
	/*
	 *
	 * IMPRESS_Options_upload function
	...
	jQuery("img[src='']").attr("src", impress_upload.url);
	
	jQuery('.impress-opts-upload').click(function() {
		header_clicked = true;
	...
	jQuery('.impress-opts-upload-remove').click(function(){
		$relid = jQuery(this).attr('rel-id');
		jQuery('#'+$relid).val('');
		jQuery(this).prev().fadeIn('slow');
		jQuery(this).prev().prev().fadeOut('slow', function(){jQuery(this).attr("src", impress_upload.url);});
